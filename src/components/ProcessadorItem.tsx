...
type ProcessadorItemDataProps = {
  data: ProcessadorItem;
};

type ProcessadorItem = {
  id: string;
  nome: string;
  descricao: string;
  imagem: string;
...
export function ProcessadorItem({ data }: ProcessadorItemDataProps) {
  ...
  return (
    ...
    >
      <TouchableOpacity
        onPress={() => navigate("DetailsProcessador", { id: data.id })}
      >
        <HStack ml={2}>
          <Image
            height={130}
